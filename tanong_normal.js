const normalQuestions = {
    kasaysayan: [
        {
            question: "Sa anong taon sinakop ng mga Hapon ang Pilipinas?",
            correct_answer: "1941",
            incorrect_answers: ["1939", "1945", "1940"]
        },
        {
            question: "Anong kasunduan ang nagtapos sa Digmaang Espanyol-Amerikano?",
            correct_answer: "Kasunduan sa Paris",
            incorrect_answers: ["Kasunduan sa Tordesillas", "Kasunduan sa Biak-na-Bato", "Kasunduan sa Versailles"]
        },
        {
            question: "Sino ang kilala bilang 'Dakilang Lumpo'?",
            correct_answer: "Apolinario Mabini",
            incorrect_answers: ["Jose Rizal", "Andres Bonifacio", "Manuel Quezon"]
        }
        // Add more normal questions for kasaysayan...
    ],
    lokasyon: [
            {
    ...
    musika: [
        {
            question: "Anong genre ng musika ang nagmula sa African-American communities noong 1940s?",
            correct_answer: "Rhythm and Blues (R&B)",
            incorrect_answers: ["Rock", "Country", "Classical"]
        },
        {
            question: "Sino ang kompositor ng 'Für Elise'?",
            correct_answer: "Ludwig van Beethoven",
            incorrect_answers: ["Wolfgang Amadeus Mozart", "Johann Sebastian Bach", "Frédéric Chopin"]
        },
        {
            question: "Anong scale ang madalas gamitin sa blues music?",
            correct_answer: "Pentatonic Scale",
            incorrect_answers: ["Chromatic Scale", "Diatonic Scale", "Whole Tone Scale"]
        }
        // Add more normal questions for musika...
    ]
};
